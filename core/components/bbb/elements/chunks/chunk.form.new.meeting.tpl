    ...
    <form class="form-horizontal" method="post" action="">
        ...
        <div class="form-group col-xs-12 col-sm 12">
            ...
            <div class="col-xs-9 col-sm-9">
                <input type="text" class="form-control" id="name_meeting" name="name_meeting" placeholder="Укажите название нового мероприятия" required>
            </div>
        </div>
        <div class="form-group col-xs-12 col-sm-12 col-md-6">
            <label for="date_meeting" class="col-xs-5 control-label"><span>Дата и время начала:</span></label>
            <div class="col-xs-7">
                <input type="datetime-local" class="form-control" id="date_meeting" name="date_meeting" required>
            </div>
        </div>
        <div class="form-group col-xs-12 col-sm-12 col-md-6">
            <label for="duration" class="col-xs-5 control-label"><span>Продолжительность:</span></label>
            <div class="col-xs-7">
                <input type="number" min="0" max="180" step="10" class="form-control" id="duration" name="duration" placeholder="в минутах" required>
            </div>
        </div>
        <div class="form-group col-xs-12 col-sm-12 col-md-6">
            <label for="maxParticipants" class="col-xs-5 control-label"><span>Количество участников:</span></label>
            <div class="col-xs-7">
                <input type="number" min="0" max="100" step="10" class="form-control" id="maxParticipants" name="maxParticipants" placeholder="" required>
            </div>
        </div>
        <div class="form-group col-xs-12 col-sm-12 col-md-6">
            <label for="logoutUrl" class="col-xs-5 control-label"><span>По окончании открыть:</span></label>
            <div class="col-xs-7">
                <input type="text" class="form-control" id="logoutUrl" name="logoutUrl" placeholder="http://web-meeting.ru" />
            </div>
        </div>
        <div class="form-group col-xs-12 col-sm-12 col-md-6">
            <label for="moderatorPw" class="col-xs-5 control-label"><span>Пароль ведущего:</span></label>
            <div class="col-xs-7">
                <input type="text" class="form-control" id="moderatorPw" name="moderatorPw" placeholder="" />
            </div>
        </div>
        <div class="form-group col-xs-12 col-sm-12 col-md-6">
            <label for="attendeePw" class="col-xs-5 control-label"><span>Пароль участника:</span></label>
            <div class="col-xs-7">
                <input type="text" class="form-control" id="attendeePw" name="attendeePw" placeholder="" />
            </div>
        </div>
        <div class="form-group col-xs-12 col-sm-12 col-md-6">
            <label for="welcomeMsg" class="col-xs-5 control-label"><span>Приветствие:</span></label>
            <div class="col-xs-7">
                <input type="text" class="form-control" id="welcomeMsg" name="welcomeMsg" placeholder="" />
            </div>
        </div>
        <div class="form-group col-xs-12 col-sm-12 col-md-6">
